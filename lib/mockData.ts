...
export interface ClassType {
  id: string;
  name: string;
  type: 'gb1' | 'gb2' | 'all-levels' | 'live-training' | 'open-mat' | 'kids-tiny' | 'kids-little' | 'kids-juniors' | 'kids-homeschool' | 'fundamentals' | 'advanced' | 'kids' | 'competition';
  days: string[];
  time: string;
...
// Real schedule: Gracie Barra Dripping Springs (gbdrip.com)
export const classTypes: ClassType[] = [
  // ── GB1 Fundamentals ──────────────────────────────────────────────────────
  {
    id: 'gb1-morning-mwf',
    name: 'GB1 Fundamentals',
    type: 'gb1',
    ...
    description: 'All-levels fundamentals. The world-famous GB1 curriculum.',
  },
  {
    id: 'gb1-noon-mwf',
    name: 'GB1 Fundamentals',
    ...
    time: '12:00',
    duration: 60,
    instructor: 'Robert Bookman',
    maxCapacity: 20,
    color: '#3b82f6',
    style: 'gi',
    ageGroup: 'Adults & Teens',
    description: 'All-levels fundamentals. Midday session.',
  },
  {
    id: 'gb1-sat',
    name: 'GB1 Fundamentals',
    ...
    style: 'gi',
    ageGroup: 'Adults & Teens',
    description: 'Saturday morning GB1 all levels.',
  },
  // ── GB2 Advanced ─────────────────────────────────────────────────────────
  {
    id: 'gb2-tue-gi',
    name: 'GB2 Advanced (Gi)',
    type: 'gb2',
    days: ['Tuesday'],
    time: '12:00',
    duration: 75,
    ...
    style: 'gi',
    ageGroup: 'Adults',
    description: 'White belt 3 stripes and up. Complex techniques + live training.',
  },
  {
    id: 'gb2-thu-nogi',
    name: 'GB2 Advanced (NoGi)',
    type: 'gb2',
    days: ['Thursday'],
    time: '12:00',
    duration: 75,
    ...
    style: 'nogi',
    ageGroup: 'Adults',
    description: 'White belt 3 stripes and up. NoGi advanced drilling + sparring.',
  },
  // ── All Levels ────────────────────────────────────────────────────────────
  {
    id: 'all-levels-gi-mtwth',
    name: 'All Levels (Gi)',
    type: 'all-levels',
    ...
    style: 'gi',
    ageGroup: 'All Adults',
    description: 'Mix of fundamental and advanced techniques. All welcome.',
  },
  {
    id: 'all-levels-nogi-tue-early',
    name: 'All Levels (NoGi)',
    type: 'all-levels',
    days: ['Tuesday'],
    time: '08:00',
    duration: 60,
    ...
    style: 'nogi',
    ageGroup: 'All Adults',
    description: 'Early morning NoGi. Rashguard and shorts.',
  },
  {
    id: 'all-levels-nogi-thu',
    name: 'All Levels (NoGi)',
    type: 'all-levels',
    days: ['Thursday'],
    time: '18:30',
    ...
    style: 'nogi',
    ageGroup: 'All Adults',
    description: 'Thursday NoGi all levels. Rashguard and shorts.',
  },
  // ── Live Training / Open Drilling ─────────────────────────────────────────
  {
    id: 'live-training-eve-mtwth',
    name: 'Live Training',
    type: 'live-training',
    ...
    style: 'both',
    ageGroup: 'Adults',
    description: 'Open sparring. Gi or NoGi optional.',
  },
  {
    id: 'live-training-fri',
    name: 'Live Training',
    type: 'live-training',
    days: ['Friday'],
    time: '13:00',
    ...
    style: 'both',
    ageGroup: 'Adults',
    description: 'Friday afternoon open sparring.',
  },
  {
    id: 'live-training-sat',
    name: 'Live Training',
    type: 'live-training',
    days: ['Saturday'],
    time: '11:30',
    ...
    style: 'both',
    ageGroup: 'Adults',
    description: 'Saturday open mat sparring. Gi or NoGi.',
  },
  // ── GBK Kids Programs ─────────────────────────────────────────────────────
  {
    id: 'gbk-tiny-mtwth',
    name: 'GBK Tiny Champs',
    type: 'kids-tiny',
    days: ['Monday', 'Tuesday', 'Wednesday', 'Thursday'],
    time: '17:00',
    duration: 45,
    ...
    description: 'Tiny Champs program. Builds confidence, focus, and fun.',
  },
  {
    id: 'gbk-tiny-sat',
    name: 'GBK Tiny Champs',
    ...
    style: 'gi',
    ageGroup: '4–6 Years Old',
    description: 'Saturday Tiny Champs.',
  },
  {
    id: 'gbk-little-mw',
    name: 'GBK Little Champs',
    type: 'kids-little',
    ...
    description: 'Little Champs. Ages 7–9.',
  },
  {
    id: 'gbk-lc-juniors-tuth',
    name: 'GBK LC + Juniors',
    type: 'kids-juniors',
    ...
    color: '#f59e0b',
    style: 'gi',
    ageGroup: '7–12 Years Old',
    description: 'Little Champs (7–9) and Juniors (10–12) combined class.',
  },
  {
    id: 'gbk-lc-juniors-sat',
    name: 'GBK LC + Juniors',
    type: 'kids-juniors',
    days: ['Saturday'],
    time: '09:30',
    ...
    style: 'gi',
    ageGroup: '7–12 Years Old',
    description: 'Saturday Little Champs and Juniors.',
  },
  {
    id: 'gbk-juniors-teens-fri',
    name: 'GBK Juniors & Teens',
    type: 'kids-juniors',
    days: ['Friday'],
    time: '17:30',
    duration: 45,
    ...
    color: '#f59e0b',
    style: 'gi',
    ageGroup: '10–15 Years Old',
    description: 'Friday Juniors and Teens class.',
  },
  {
    id: 'gbk-homeschool-tue',
    name: 'GBK Homeschool',
    type: 'kids-homeschool',
    days: ['Tuesday'],
    time: '11:00',
    duration: 45,
    instructor: 'Robert Bookman',
    ...
    description: 'Midday class for homeschool families. All kids welcome.',
  },
  {
    id: 'gbk-homeschool-nogi-thu',
    name: 'GBK Homeschool (NoGi)',
    type: 'kids-homeschool',
    days: ['Thursday'],
    time: '11:00',
    duration: 45,
    ...
    style: 'nogi',
    ageGroup: '6–12 Years Old',
    description: 'Thursday NoGi homeschool. Rashguard and shorts.',
  },
];
